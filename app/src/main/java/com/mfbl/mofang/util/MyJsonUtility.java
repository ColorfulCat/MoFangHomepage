...
/**
 * @author libin -- 下午4:22:24
 * @desc JSON手动解析类， 排除无KEY解析时的报空问题
 */
public class MyJsonUtility {

	private static final String SPACE = "";

	public int getJsonIntegerResult(JSONObject jsonObject, String key) {
		int jsonIntResult = -1;
		try {
	...
	public String getJsonStringResult(JSONObject jsonObject, String key) {
	...
	public double getJsonDoubleResult(JSONObject jsonObject, String key) {
	...
	public List<String> getJsonStringListResult(JSONObject jsonObject, String key) {
	...
	public JSONArray getJsonArrayResult(JSONObject jsonObject, String key) {
	...
	public JSONObject getJsonObjectResult(JSONObject jsonObject, String key) {
	...
	public boolean getJsonBooleanResult(JSONObject jsonObject, String key) {
